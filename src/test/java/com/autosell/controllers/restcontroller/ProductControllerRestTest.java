    ...
    import com.autosell.controllers.user.ProductController;
    import com.autosell.domains.Product;
    import com.autosell.repositories.ProductRepository;
    import com.autosell.serviceImpl.ProductServiceImpl;
    ...
    @InjectMocks
    private ProductControllerRest controller;
...
//    Product product1,product2,product3,product4,product5;
    ...
    public void getAllProducts() {
        ...
        Assertions.assertThat(5).isEqualTo(controller.getAllProducts().size());
    }
    ...
    public void getById() {
        ...
        Assertions.assertThat(product1).isEqualTo(controller.getById(id));
    }
//
//    @Test
//    public void addProduct() {
//        Mockito.when(productService.save(product1)).thenReturn(product1);
//        Assertions.assertThat(product1).isEqualTo(controller.addProduct(product1));
//    }
//    @Test
//    public void deleteProductById() {
//        Long id = 1l;
//        Mockito.when(productService.findById(id)).thenReturn(java.util.Optional.ofNullable(product1));
//        Assertions.assertThat(product1).isEqualTo(controller.deleteProductById(1l));
//    }
